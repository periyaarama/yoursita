...
<!-- Floating Pink Plus Button for Admin Upload -->
@auth
    @if(Auth::user()->hasRole('admin'))
        <div class="flex justify-center mt-10">
            <form action="{{ route('admin.handhenna.upload') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                @csrf
